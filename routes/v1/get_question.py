...
def get_question():
    ...
    if not question_number:
        return {"success": False, "error": "question_number not provided"}, 403
    question_number = int(question_number)

    if question_number > run.question_count:
        return {"success": False, "error": "question_number higher than the run question count"}, 403
    ...
    return {
        "success": True,
        "data": QuestionsData.questions_dict[theme][hash]
    }, 200